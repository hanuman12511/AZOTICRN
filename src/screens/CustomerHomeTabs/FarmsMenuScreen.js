...
class FarmsMenuScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      products: null,
  ...
  fetchCartCount = async () => {
    try {
      ...
      console.log('====================================');
      console.log('farmmenucart =', response);
      console.log('====================================');
  ...
  fetchVendorMenu = async (selectedSlots = null) => {
    try {
      ...
      if (response) {
        ...
        console.log('====================================');
        console.log('venderpro=', response);
        console.log('====================================');
        if (success) {
  ...
  handleAddToCart = async () => {
    ...
    console.log('====================================');
    console.log('addtocat=', this.state);
    console.log('====================================');
...
export default connect(mapStateToProps, mapDispatchToProps)(FarmsMenuScreen);
