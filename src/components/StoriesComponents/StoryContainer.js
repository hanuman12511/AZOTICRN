...
const StoryContainer = (props) => {
  ...
  const handleReaction = (reaction) => async () => {
    const {id: postId} = story;
    await reactToStory(postId, reaction);
    props.onClose();
  };

  const handlePollReply = (reply) => async () => {
    const {id: postId} = story;
    await replyToStory(postId, '', reply);
    props.onClose();
  };
  ...
  return (
    <GestureRecognizer
      ...
      <TouchableOpacity
            ...
            story.isAnswered === false ? (
              <View style={styles.mainPollContainer}>
                ...
                <View style={styles.pollContainer}>
                  <TouchableOpacity
                    style={[styles.pollButtonStyle]}
                    onPress={handlePollReply('Y')}>
                    <Text style={[basicStyles.textBold, {color: '#fff'}]}>
                      Yes
                    </Text>
                  </TouchableOpacity>
                  <View
        ...
        {isReportPop === false ? (
          story.isReacted === false ? (
            <View style={styles.mainReactionBoxContainer}>
              <TouchableOpacity onPress={handleReaction('likedIt')}>
              ...
              <TouchableOpacity onPress={handleReaction('delicious')}>
              ...
              <TouchableOpacity onPress={handleReaction('shock')}>
