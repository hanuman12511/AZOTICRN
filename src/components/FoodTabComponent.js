...
// Images
import ic_rate_star from '../assets/icons/ic_rate_star.png';
import ic_half_rating from '../assets/icons/ic_half_rating.png';
...
import ic_no_rate from '../assets/icons/ic_no_rate.png';
        ...
        <View style={styles.orderContainer}>
          ...
          <View style={styles.contentContainer}>
            ...
            <Text style={styles.descText}>
              {bio}
              {/* Specialises in Chicken, Mutton and Other Mughlai Dishes. */}
            </Text>
